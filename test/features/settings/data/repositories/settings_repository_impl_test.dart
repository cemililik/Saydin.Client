...
void main() {
  ...
  group('SettingsRepositoryImpl (F-12-04 enum.name + migration)', () {
    test('save_darkThemeEnLanguage_writesEnumNameStrings', () async {
    ...
    test('load_newStringFormat_resolvesToEnums', () async {
      when(
    ...
    test('load_legacyIntIndex_migratesAndRewritesOnce', () async {
    ...
    test('load_getStringTypeMismatch_fallsBackToGetInt', () async {
    ...
    test('load_missingValues_defaultsToSystem', () async {
      when(() => prefs.getString(any())).thenAnswer((_) async => null);
    ...
    test('load_outOfRangeLegacyIndex_defaultsToSystem', () async {
      when(() => prefs.getString(any())).thenAnswer((_) async => null);
