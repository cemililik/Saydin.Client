...
class ShareCardWidget extends StatelessWidget {
  ...
  // Ortak [DurationLabel]'a delege (F-07-20). Public static korunur — 3 harici
  // paylaşım kartı (portfolio/comparison/reverse) bu çağrıyı kullanıyor.
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      durationLabel(l10n, result.buyDate, effectiveSellDate),
                      style: const TextStyle(
                        fontSize: 13,
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            tryFmt.format(result.initialValueTry.toDouble()),
                            style: const TextStyle(
                              fontSize: 17,
                              fontWeight: FontWeight.w600,
                              color: ShareCardColors.textPrimary,
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 2),
                          Text(
                            tryFmt.format(result.finalValueTry.toDouble()),
                            style: const TextStyle(
                              fontSize: 17,
                              fontWeight: FontWeight.bold,
                              color: ShareCardColors.textPrimary,
