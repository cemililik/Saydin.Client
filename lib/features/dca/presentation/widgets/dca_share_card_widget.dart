...
/// DCA sonucu için sosyal medya paylaşım kartı.
/// Theme bağımsız: her zaman açık zemin, sabit renkler.
class DcaShareCardWidget extends StatelessWidget {
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      _durationLabel(l10n, result.startDate, result.endDate),
                      style: const TextStyle(
                        fontSize: 13,
              ...
              // Toplam Yatırım → Güncel Değer kutusu
              Container(
                padding: const EdgeInsets.symmetric(
                  horizontal: 16,
                  vertical: 12,
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            tryFmt.format(result.totalInvestedTry.toDouble()),
                            style: const TextStyle(
                              fontSize: 17,
                              fontWeight: FontWeight.w600,
                              color: ShareCardColors.textPrimary,
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 2),
                          Text(
                            tryFmt.format(result.currentValueTry.toDouble()),
                            style: const TextStyle(
                              fontSize: 17,
                              fontWeight: FontWeight.bold,
                              color: ShareCardColors.textPrimary,
                ...
                child: Row(
                  children: [
                    _MiniStat(
                      ...
                      value: tryFmt.format(result.periodicAmount.toDouble()),
                    ),
                    _MiniStat(
                      label: l10n.dcaTotalPurchases,
                      value: result.totalPurchases.toString(),
                    ),
                    _MiniStat(
